...
#
%define         web_files_location     /srv/www/htdocs/
Name:           pi-hole-web
Version:        6.6
Release:        1.1
...
Source0:        pi-hole-web-%{version}.tar.gz
Requires:       pi-hole
...
BuildArch:      noarch
Provides:       pi-hole-admin-lte = %{version}
Obsoletes:      pi-hole-admin-lte < %{version}
...
cp -dpr --no-preserve=ownership ./* %{buildroot}%{web_files_location}/admin/
